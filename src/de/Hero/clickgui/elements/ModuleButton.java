...
public class ModuleButton {
	...
	public ModuleButton(Module imod, Panel pl) {
		 ...
		 *  f�r ein Setting bentigt wird :>
		 */
		if (imod.getValues() != null)
			for (Value v : imod.getValues()) {
				if (v instanceof Booleans) {
					menuelements.add(new ElementCheckBox(this, v));
				} else if (v instanceof Numbers) {
					menuelements.add(new ElementSlider(this, v));
				} else if (v instanceof Mode) {
					menuelements.add(new ElementComboBox(this, v));
				}
			}
