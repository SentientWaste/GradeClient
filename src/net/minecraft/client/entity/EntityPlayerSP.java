...
import Client.event.events.EventMove;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventPreUpdate pre = new EventPreUpdate(this.rotationYaw, this.rotationPitch, this.posY, this.onGround);
        EventPostUpdate post = new EventPostUpdate(this.rotationYaw, this.rotationPitch, this.posY, this.onGround);
        EventManager.instance.call(pre);
        if (pre.isCancelled()) {
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        EventManager.instance.call(eventMove);
